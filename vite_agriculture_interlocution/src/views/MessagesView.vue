...
export default {
  ...
  setup() {
    ...
    const messages = ref([
      ...
      { icon: '/images/plant.gif', title: '种植消息', content: '空', to: '/planting-message', unread: true },
      { icon: '/images/like-comment.gif', title: '赞评消息', content: '空', to: '/like-comment-message', unread: false },
      { icon: '/images/system.gif', title: '系统通知', content: '空', to: '/system-notification', unread: true },
    ]);
